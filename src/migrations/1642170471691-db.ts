...
export class db1642170471691 implements MigrationInterface {
    name = 'db1642170471691'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "firstName" character varying(50) NOT NULL, "lastName" character varying(50) NOT NULL, "avatar" character varying, "email" character varying NOT NULL, "isVerifiedEmail" boolean NOT NULL DEFAULT false, "phone" character varying(15), "role" "public"."user_role_enum" NOT NULL DEFAULT 'Member', "password" character varying, "salt" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "social" ("id" SERIAL NOT NULL, "socialId" character varying NOT NULL, "provider" "public"."social_provider_enum" NOT NULL, "firstName" character varying, "lastName" character varying, "avatar" character varying, "email" character varying, "phone" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updatedAt" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "userId" integer, CONSTRAINT "PK_645aa1cff2b9f7b0e3e73d66b4d" PRIMARY KEY ("id"))`);
